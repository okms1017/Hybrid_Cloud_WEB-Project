        ...
        <table class="table">
            ...
            <?php
                    ...
                    while ($row = $result->fetch_assoc()){
                        ...
                        print "<tr class='$st'>";
                            print "<td>$row[No]</td>";
                            print "<td><a style='color: black;' href='/php/board_read_nologin.php?page=$row[No]'>$row[Title]</a></td>";
                    ...
                    <td colspan=12>
                        ...
                        <div class='row'>
                            ...
                            <div id="searchBox3" class="searchBox">
                                <form name="formSearchBy" action="./board_search.php" method="get">
                                <div class="flex-container">
                                    <div id="divSearchBy3" class="flex-container-child" style="width:144px">
                                    ...
                                    <div class="flex-container-child" style="width:200px">
                                        <input type="text" id="query3" name="query" class="form-control" placeholder="검색할 내용을 입력하세요" required>
                                    </div>&nbsp;&nbsp;
